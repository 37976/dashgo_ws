...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("camera_publish_hz", default_value="30.0"),
            DeclareLaunchArgument("camera_max_width", default_value="320"),
            DeclareLaunchArgument("camera_jpeg_quality", default_value="55"),
                ...
                parameters=[
                    {
                        ...
                        "camera_publish_hz": LaunchConfiguration("camera_publish_hz"),
